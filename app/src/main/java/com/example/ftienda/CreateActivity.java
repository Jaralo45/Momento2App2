...
public class CreateActivity extends BaseActivity {
        ...
        fab_create_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (serial.isEmpty() || description.isEmpty() || brand.isEmpty()){
                    makeSimpleAlertDialog("Información","Por favor llene todos los campos");
                }else{
    ...
    private void save(ComputerModel model) {
        if (collectionReference != null){
                ...
                public void onComplete(@NonNull Task<DocumentReference> task) {
                    if (task.isSuccessful()){
                        if (task.getResult() != null){
                            makeSimpleAlertDialog("Correcto","Información guardada");
                            clear();
                        }else{
                            makeSimpleAlertDialog("Advertencia","La información no se guardó");
                        }
                    }else{
            ...
            makeSimpleAlertDialog("Error","No hay conexion");
        }
    }
    ...
    protected void init(){
        ...
        tv_create_clic_image = findViewById(R.id.tv_create_clic_image);
    ...
    private void clear(){
        ...
        iv_create_image.setImageResource(R.drawable.ic_computer_24px);
    }
